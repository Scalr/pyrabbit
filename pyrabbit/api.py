...
class Client(object):
    ...
    def __init__(self, url, user, passwd, api_suffix='api', timeout=5, scheme='http', verify=None):
        """
        :param string url: base url for the broker host. Example: localhost:5671
        ...
        """
        self.api_url = '%s/%s/' % (url.split('/')[0], api_suffix)
        self.user = user
        self.passwd = passwd
